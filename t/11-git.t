...
use FindBin '$RealBin';
use lib $RealBin;
use Test::Sbotools qw/ set_repo sbopsnap /;
...
# 4: sbopsnap update through merge conflict
sbopsnap 'update', { expected => qr!Updating SlackBuilds tree.*master.*->.*origin/master.*forced update.*HEAD is now at!s };
