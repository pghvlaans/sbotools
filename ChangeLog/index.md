...
* Post-Release
  ...
  * *sbofind*, *sbocheck*, *sboconfig -l*, *sboinstall*, *sboupgrade*, *sboremove*: Show a warning if the specified local overrides directory does not exist; exit if **\--batch**
...
## Historical Changes
*Note*: [pink-mist/sbotools](https://github.com/pink-mist/sbotools/) was the home of **sbotools** development during this time. Unless indicated otherwise, the changes below are thanks to Andreas Guldstrand.
...
* 2.6 - 2019-04-27
  ...
  * Add a *\--tries 5* option when downloading from sbosrcarch, which is a saner limit than the default of 20. #79
