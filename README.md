...
## Changes
* 2.7 - 2019-04-28
  * Actually fix the sbopfind -e bug #71
...
* 2.6 - 2019-04-27
  ...
  * Change sbopclean options --clean-dist and --clean-work to shorter forms #52
  * Add limited -current support using ponce's SBo repo for -current #73
  * Fix bug with sbopinstall --reinstall -r #72
  * Fix bug with sbopfind -e #71

* 2.5 - 2018-02-14
  * Document download behaviour #66
  * Remake sbopsnap and sbopremove to have OO semantics
  * Strip -compat32 from slackbuild names when looking them up #65
  * Optimise searching in sbopfind

* 2.4 - 2017-05-18
  * Rewrite sbopremove from the ground up so it relies less on global state
  * Fix for parsing README with useradd/groupadd commands which span lines #57
  * Add --reinstall option to sbopinstall #58
  * Exit with error when sbopsnap fails to sync with a repo #61
  * Add version information to sbopfind output #60
...
* 2.1 - 2017-01-14
  ...
  * Bugfixes
    - sbopinstall/sbopremove disagreeing about a package being installed #44
    - sbopcheck and sbopupgrade misinterpreting version strings #45
...
* 2.0 - 2016-07-02
  * Major new features
    ...
    * sbopupgrade --all option to upgrade everything listed by sbopcheck. #9 #19
    ...
    * sbopfind will now also use tags if they're available #37
  * Minor/bugfixes/documentation fixes
    * Use system perl when running and installing sbotools.
    * sbopcheck output changed. #10 #13 #20
    * Better debug messages on errors. #16
    * manpage fixes. #17
    * sbopupgrade handles dependencies better. #12 #28
    * Update bundled Sort::Versions to 1.62.
    * sbopinstall/upgrade/sbopcheck: small bugfixes. #21 #35 #41 #43
    * sbopsnap: display download progress, update git trees better. #26 #27
